...
public class UrlMappingRegistry {
    ...
    private final Map<String, MappingInfo> urlMappings;
    ...
    public void buildRegistry(List<Class<?>> classes) {
        if (initialized) {
            System.out.println("[Registry] Déjà initialisé.");
            return;
        }
        ...
        initialized = true;
        System.out.println("[Registry] Construit: " + urlCount + " URL(s) mappée(s).\n");
    }
